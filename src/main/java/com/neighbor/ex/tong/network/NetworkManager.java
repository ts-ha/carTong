...
import com.neighbor.ex.tong.network.request.JSONObjectRequest;
...
public class NetworkManager extends AbsNetworkManager {
     ...
     */
    public void requestJsonObject(Context context, String url, int requestType,
                                  Handler handler, int succMsg, int failMsg, final String requestPersonalId) {
        ...
        JSONObjectRequest jsObjRequest = new JSONObjectRequest(requestType,
                url, new JsonObjectSuccessListener(handler, isDismissDialog,
                succMsg), new ErrorListener(handler, isDismissDialog,
                failMsg)) {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put(HTTP_HEADER_ACCEPT_LANGUAGE, Locale.getDefault()
                        .getLanguage());
     ...
     */
    public void requestJsonObject(Context context, String url, int requestType,
                                  Handler handler, int succMsg, int failMsg) {
        requestJsonObject(context, url, requestType, handler, succMsg, failMsg, null);
    }
     ...
     * @param requestPersonalId 요청 personal id
     */
    public void requestJsonObject(String url, int requestType, Handler handler,
                                  int succMsg, int failMsg, final String requestPersonalId) {
        requestJsonObject(null, url, requestType, handler, succMsg, failMsg, requestPersonalId);
    }
     ...
     */
    public void requestJsonObject(String url, int requestType, Handler handler,
                                  int succMsg, int failMsg) {
        requestJsonObject(null, url, requestType, handler, succMsg, failMsg, null);
    }
     ...
     * @param requestPersonalId 요청 personal id
     */
    public void requestString(Context context, String url, int requestType,
                              Handler handler, int succMsg, int failMsg, final String requestPersonalId) {
        boolean isDismissDialog = false;
        if (context != null) {
            // UICommonUtil.getInstance(context).showProgressDialog(context);
     ...
     * @param requestPersonalId 요청 personal id
     */
    public void requestString(String url, int requestType, Handler handler,
                              int succMsg, int failMsg, final String requestPersonalId) {
        requestString(null, url, requestType, handler, succMsg, failMsg, requestPersonalId);
    }
    ...
    public void requestString(String url, int requestType, Handler handler,
                              int succMsg, int failMsg) {
        requestString(null, url, requestType, handler, succMsg, failMsg, null);
    }
     ...
     *            실패 메시지 상수
     */
    // public void requestFile(Context context, String fileUrl, String savePath,
    // Handler handler, int succMsg, int failMsg) {
    // boolean isDismissDialog = false;
    // if (context != null) {
    // UICommonUtil.getInstance(context).showProgressDialog(context);
    // isDismissDialog = true;
    // }
    // FileRequest fileRequest = new FileRequest(fileUrl, savePath, new
    // FileSuccessListener(handler, isDismissDialog, succMsg), new
    // ErrorListener(handler, isDismissDialog,
    // failMsg));
     ...
     *            실패 메시지 상수
     */
    // public void requestFile(String fileUrl, String savePath, Handler handler,
    // int succMsg, int failMsg) {
     ...
     *            실패 메시지 상수
     */
    // public void requestImage(String url, Handler handler, AsyncImageView
    // imageView, int failMsg) {
    // if (imageManager.isContain(url)) {
    // imageView.setImageUrl(url, imageManager);
    // return;
    // }
    // ImgRequest imageRequest = new ImgRequest(imageManager, imageView, url,
    // new ErrorListener(handler, false, failMsg));
     ...
     *            실패 메시지 상수
     */
    // public void updateImage(String url, Handler handler, AsyncImageView
    // imageView, int failMsg) {
    // if (imageManager.isContain(url)) {
     ...
     *            실패 메시지 상수
     */
    // public void sendMultipart(Context context, String url, int requestType,
    // MultipartEntity entity, Handler handler, int succMsg, int failMsg) {
    //
    // boolean isDismissDialog = false;
    // if (context != null) {
    // UICommonUtil.getInstance(context).showProgressDialog(context);
    ...
    // requestType, entity, new MultipartSuccessListener(handler,
    // isDismissDialog, succMsg), new ErrorListener(
    ...
    // Map<String, String> headers = new HashMap<String, String>();
    //
    // headers.put(HTTP_HEADER_ACCEPT_LANGUAGE,
     ...
     *            실패 메시지 상수
     */
    // public void sendMultipart(String url, int requestType, MultipartEntity
    // entity, Handler handler, int succMsg, int failMsg) {
    ...
    public class StringSuccessListener implements Response.Listener<String> {
         ...
         */
        StringSuccessListener(Handler handler, boolean isDismissDialog,
                              int succMsg) {
...
//                CommonProgressDialog.showProgressDialog(context);
     ...
     * @since : J2SE 6.0
     */
    public class JsonObjectSuccessListener implements
         ...
         * @param succMsg 성공 메시지 상수
         */
        JsonObjectSuccessListener(Handler handler, boolean isDissmissDialog,
                                  int succMsg) {
        ...
        public void onResponse(JSONObject response) {
            if (handler != null) {
                handler.sendMessage(handler.obtainMessage(succMsg,
                        response.toString()));
            }
            if (isDismissDialog == true) {
                // UICommonUtil.getInstance(networkManagerContext).dismissDialog();
     ...
     * @since : J2SE 6.0
     */
    public class MultipartSuccessListener implements
            Response.Listener<JSONObject> {
         ...
         * @param succMsg 성공 메시지 상수
         */
        MultipartSuccessListener(Handler handler, boolean isDismissDialog,
                                 int succMsg) {
            this.isDismissDialog = isDismissDialog;
            this.succMsg = succMsg;
            this.handler = handler;
    ...
    public class FileSuccessListener implements Response.Listener<String> {
         ...
         * @param succMsg 성공 메시지 상수
         */
        FileSuccessListener(Handler handler, boolean isDismissDialog,
                            int succMsg) {
            this.isDismissDialog = isDismissDialog;
            this.succMsg = succMsg;
            this.handler = handler;
    ...
    public class ErrorListener implements Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError error) {
            if (handler != null) {
                handler.sendMessage(handler.obtainMessage(errorMsg,
                        error.toString()));
            }
            if (isDismissDialog == true) {
                // UICommonUtil.getInstance(networkManagerContext).dismissDialog();
