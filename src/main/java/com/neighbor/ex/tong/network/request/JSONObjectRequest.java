 ...
 *
 */
package com.neighbor.ex.tong.network.request;
...
public class JSONObjectRequest extends Request<byte[]> {
     ...
     */
    public JSONObjectRequest(int requestType, String url,
                             NetworkManager.JsonObjectSuccessListener successListener,
                             NetworkManager.ErrorListener listener) {
